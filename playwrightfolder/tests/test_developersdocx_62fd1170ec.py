...
from pages.developersdocx_62fd1170ec_page import ScenarioPage

WORKSPACE_ROOT = Path(__file__).resolve().parents[2]
USECASE_FILE = WORKSPACE_ROOT / "playwrightfolder" / "data" / "developersdocx_62fd1170ec_usecases.json"
